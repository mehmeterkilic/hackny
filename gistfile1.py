...
class TumblrAPI:
    ...
    def oauth_sig(self,method,uri,params):
        ...
        '%26'.join([urllib.quote(k) +'%3D' + urllib.quote(params[k]).replace('/','%2F') for k in sorted(params.keys())])
        s = s.replace('%257E','~')
...
cred = { "consumer_key" : 'PGDNJnjMFvSZr1kie4HSItsGDFQE3Dd6CN6DJXP2i1pUSDk6uI',
        'secret_key' : 'OGZkYnYWAEFlzRVjKOFVHqIAM43WpeZ2xqCxARLoHfriluIZW7',
